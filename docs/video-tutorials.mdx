...
export const links = [
  ...
  'https://www.youtube-nocookie.com/embed/WFpYRT3W6rg',
  'https://www.youtube-nocookie.com/embed/IavM3PAAcb0',
  'https://www.youtube-nocookie.com/embed/16mgS-6hlL0'
]

export const titles = [
  'Dashboard overview',
  'Submitting sample from user perspective',
  'Experiments search',
  'Reset password workflow',
  'Resubmit sample workflow'
]
