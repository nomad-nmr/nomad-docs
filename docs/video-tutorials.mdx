...
export const links = [
  'https://www.youtube.com/embed/axzK1qiwloA',
  'https://www.youtube.com/embed/SRDQqJkQFXc'
]

export const titles = [
  'How to start with NOMAD using AUTO-FEED function',
  'Current NOMAD workflow from user perspective'
]
